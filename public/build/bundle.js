...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 10, 1, 170);
    			attr_dev(input0, "type", "text");
    			add_location(input0, file, 11, 1, 202);
    			attr_dev(input1, "type", "text");
    			add_location(input1, file, 12, 1, 246);
    			attr_dev(input2, "type", "text");
    			add_location(input2, file, 13, 1, 289);
    			attr_dev(main, "class", "svelte-1tky8bj");
    			add_location(main, file, 9, 0, 162);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*city*/ 4) set_data_dev(t2, /*city*/ ctx[2]);
    			...
    			if (dirty & /*city*/ 4 && input2.value !== /*city*/ ctx[2]) {
    				set_input_value(input2, /*city*/ ctx[2]);
    			}
    		},
    		i: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ firstName, lastName, city, fullName });
